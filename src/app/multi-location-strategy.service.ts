...
import {APP_BASE_HREF, LocationChangeListener, LocationStrategy, PlatformLocation, Location} from "@angular/common";

@Injectable({
  providedIn: 'root'
})
export class MultiLocationStrategyService extends LocationStrategy{
